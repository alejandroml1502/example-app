...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('base_appoption', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('optname', 50)->nullable();
            $table->string('value', 50)->nullable();
            $table->string('discribe', 50)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('base_appoption');
    }
};
