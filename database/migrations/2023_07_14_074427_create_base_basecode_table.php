...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('base_basecode', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('content_class')->nullable()->default(0);
            $table->string('display', 50)->nullable();
            $table->string('value', 50)->nullable();
            $table->string('remark', 50)->nullable();
            $table->string('is_add', 50)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('base_basecode');
    }
};
