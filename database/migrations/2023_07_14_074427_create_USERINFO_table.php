...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('USERINFO', function (Blueprint $table) {
            ...
            $table->integer('DEFAULTDEPTID')->nullable()->default(1);
            $table->smallInteger('SECURITYFLAGS')->nullable();
            $table->smallInteger('ATT')->default(1);
            $table->smallInteger('INLATE')->default(1);
            $table->smallInteger('OUTEARLY')->default(1);
            $table->smallInteger('OVERTIME')->default(1);
            $table->smallInteger('SEP')->default(1);
            ...
            $table->integer('privilege')->nullable()->default(0);
