...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('iclock_dstime', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('dst_name', 50)->nullable()->unique('UQ__iclock_d__F7CC257680F89705');
    ...
    {
        Schema::dropIfExists('iclock_dstime');
    }
};
